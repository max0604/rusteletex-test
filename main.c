...
static int decrypt_cbc(int mode, uint8_t* key);
static int encrypt_cbc(int mode, uint8_t* key);
...
int main(int argc, char* argv[])
{
    ...
    if(strlen(login) > 16 || strlen(passwd) > 16) {
        printf("Input error: login or passwd lenth more then 16 bytes\n"); return -1;
    }
