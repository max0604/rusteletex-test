...
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile rusteletex-test.pro
#############################################################################
...
DISTDIR = /home/max/my-projects/tmp/rusteletex-test/.tmp/rusteletex-test1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: rusteletex-test.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile rusteletex-test.pro
